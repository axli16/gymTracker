...
export default function Core ({exercise, addExercise, deleteExercise, updateExerciseNotes,section ,addSideBarContent,inputValues, setInputValues,sidebarContent, setSidebarContent}){
