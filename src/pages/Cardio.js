...
export default function Cardio ({exercise, addExercise, deleteExercise, updateExerciseNotes,section ,addSideBarContent,inputValues, setInputValues,sidebarContent, setSidebarContent}){
